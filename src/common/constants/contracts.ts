...
> = {
  ...
  SUI: {
    // Using testnet addresses in development, mainnet in production
    USDT: process.env.NODE_ENV === 'production'
      ? (process.env.SUI_MAINNET_USDT_ADDRESS || '0xc060006111016b8a020ad5b33834984a437aaa7d3c74c18e09a95d48aceab08c::coin::COIN')
      : (process.env.SUI_TESTNET_USDT_ADDRESS || '0x0000000000000000000000000000000000000000::usdt::USDT'),
    USDC: process.env.NODE_ENV === 'production'
      ? (process.env.SUI_MAINNET_USDC_ADDRESS || '0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN')
      : (process.env.SUI_TESTNET_USDC_ADDRESS || '0x0000000000000000000000000000000000000000::usdc::USDC'),
    DAI: process.env.NODE_ENV === 'production'
      ? (process.env.SUI_MAINNET_DAI_ADDRESS || '0x0000000000000000000000000000000000000000::dai::DAI')
      : (process.env.SUI_TESTNET_DAI_ADDRESS || '0x0000000000000000000000000000000000000000::dai::DAI'),
    BUSD: process.env.NODE_ENV === 'production'
      ? (process.env.SUI_MAINNET_BUSD_ADDRESS || '0x0000000000000000000000000000000000000000::busd::BUSD')
      : (process.env.SUI_TESTNET_BUSD_ADDRESS || '0x0000000000000000000000000000000000000000::busd::BUSD'),
  },
  TON: {
    USDT: '0x0000000000000000000000000000000000000000',
